    ...
    <footer className="style-2">
      <div className="footer-top dark-view padding-tb">
        <div className="container">
          <div className="row g-4 row-cols-xl-4 row-cols-sm-2 justify-content-center">
            <div className="col">
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="section-wrapper">
            <p>&copy; 2023 <Link to="/">Blogify</Link>Designed by <a href="/" target="_black">Suleman Shakeel</a></p>
